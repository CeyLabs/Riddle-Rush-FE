      ...
      <DialogContent className="sm:max-w-[425px]">
        <form onSubmit={handleSubmit(onSubmit)}>
          <DialogHeader>
            ...
            <DialogDescription>Give your riddle campaign a name to get started.</DialogDescription>
          </DialogHeader>
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <div className="col-span-3 space-y-2">
                <Input
                  ...
                  {...register("name")}
                  className={`transition-all duration-200 ${errors.name ? "border-destructive focus:ring-destructive/20" : "focus:ring-binance-yellow/20"}`}
                />
                {errors.name && (
          ...
          <DialogFooter>
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="bg-binance-yellow text-black hover:bg-binance-yellow/90 transition-all duration-200 hover:scale-105 disabled:hover:scale-100"
            >
              {isLoading ? (
